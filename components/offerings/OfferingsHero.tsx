...
export default function OfferingsHero() {
  ...
  const words = "OUR OFFERINGS".split("")
    ...
    <section ref={ref} className="relative h-[70vh] overflow-hidden">
      ...
      <motion.div style={{ y }} className="absolute inset-0 z-0">
        <Image
          ...
          alt="Our Offerings - Creating Opportunities International"
          fill
          priority
      ...
      <div className="container mx-auto px-4 h-full flex items-center relative z-10">
        <motion.div style={{ opacity }} className="max-w-4xl">
          ...
          >
            COMPREHENSIVE SOLUTIONS FOR YOUR GROWTH AND SUCCESS
          </motion.p>
          ...
          >
            <Button asChild className="bg-white text-primary hover:bg-white/90 hover:scale-105 transition-transform">
